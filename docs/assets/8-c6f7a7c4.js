const b=`[解]\r
\r
 (I) $|\\symbfit{A}-\\lambda \\symbfit{E}|=\\left|\\begin{array}{ccc}2-\\lambda & -1 & -1 \\\\\\\\\\\\ -1 & 2-\\lambda & -1 \\\\\\\\\\\\ -1 & -1 & 2-\\lambda\\end{array}\\right|=-\\lambda(3-\\lambda)^2=0, \\symbfit{A}$ 的特征值为 $\\lambda_1=0, \\lambda_2=\\lambda_3=3$.\r
\r
当 $\\lambda_1=0$ 时, 有 $\\symbfit{A}-0 \\symbfit{E}=\\symbfit{A} \\sim\\left(\\begin{array}{ccc}1 & 0 & -1 \\\\ 0 & 1 & -1 \\\\ 0 & 0 & 0\\end{array}\\right)$, 特征向量 $\\symbfit{\\xi}_1=\\left(\\begin{array}{l}1 \\\\ 1 \\\\ 1\\end{array}\\right)$, 单位化 $\\symbfit{e}_1=\\frac{1}{\\sqrt{3}}\\left(\\begin{array}{l}1 \\\\ 1 \\\\ 1\\end{array}\\right)$;\r
\r
...
当 $k_1=k_2=0$ 时, $r(\\boldsymbol{X})=0$, 当 $k_1, k_2$ 不全为 0 时, $r(\\boldsymbol{X})=1$. -->`;export{b as default};
