const n=`**解：**\r
\r
因为$\\displaystyle\\lim_{n\\to\\infty}\\sqrt[n]{\\displaystyle\\frac{1}{n(2 n-1)}}=1$, 所以收敛半径为$1$.\r
\r
当 $x= \\pm 1$ 时, $\\displaystyle\\sum_{n=1}^{\\infty} \\frac{(-1)^{n-1}}{n(2 n-1)}$ 绝对收敛, 故收敛域为 $[-1,1]$.\r
\r
