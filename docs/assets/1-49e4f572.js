...
## 关于极限常见的计算问题 \r
\r
对于极限的计算方法很多，如等价无穷小代换，泰勒展开，洛必达，倒代换，有理化，拉格朗日中值定理，积分中值定理，夹逼准则，定积分定义等.\r
\r
### 带根号的极限计算  \r
\r
**<例题4>** \r
...
\r
**[分析]** 因为$f(\\frac{1}{n})\\to f(0)$就将$f(0)=1$带入原极限，就是标准的错误，经典的零分.原因直接带入所得为$1^{\\infty}$，实际上是一个未定式.故我们考虑对式子进行处理.\r
\r
**[解]**\r
\r
