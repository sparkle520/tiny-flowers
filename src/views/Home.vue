...
<template>
  <div id="home_main">
    ...
    <div class="page_1  r f a_c j_c_c">
      ...
      <svg class="page_1_circle a" xmlns="http://www.w3.org/2000/svg" version="1.1"
        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 1422 800">
        <defs>
        ...
        <g fill="url(#cccircular-grad)">
          ...
          <circle r="320" cx="711" cy="400"></circle>
          <circle r="288" cx="711" cy="400"></circle>
          <circle r="256" cx="711" cy="400"></circle>
          <circle r="224" cx="711" cy="400"></circle>
          <circle r="192" cx="711" cy="400"></circle>
          <circle r="160" cx="711" cy="400"></circle>
          <circle r="128" cx="711" cy="400"></circle>
          <circle r="96" cx="711" cy="400"></circle>
          <circle r="64" cx="711" cy="400"></circle>
        </g>
      </svg>
      <div class="page_1_title flex a f_d_c a_c j_c_c">

        <div class="title_1 r f f_d_c a_c"><img class="avatar" :src="user_store.avatar" alt="">
          <div class="title_1_text a">你好！我是 <span>{{ user_store.name }}</span>，这里是我的博客。<br>
            主要分享自己日常学习的内容和感悟，写博客是为了和过去以及未来的自己对话。</div>
        </div>

      </div>
      <svg t="1706806114679" @click="go_to_next_page" class="icon more a" viewBox="0 0 1664 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="6659" width="32" height="32">
        <path
      ...
      <div class="page_container f f_d_c">
        <div class="page_2_header fade_out">
          <div class="notice f f_d_r a_c">
            <svg t="1706870364802" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="5227" width="28" height="28">
              <path
                ...
                fill="#5e63b6" p-id="5228"></path>
              <path d="M632.414815 183.751111v638.482963l132.740741 60.112593V140.136296l-132.740741 43.614815z"
                fill="#a393eb" p-id="5229"></path>
              <path
              ...
              <path
                ...
                fill="#5e63b6" p-id="5231"></path>
            </svg>
            <span class="notice_text"></span>
          </div>
        </div>
        <div class="page_content f f_d_r j_c_c">
          <div class="page_mid f f_d_c">
            <div class="page_top_box f f_d_r">
              <HomeCarousel class="home_carousel fade_out" :data="carousel_data"></HomeCarousel>
              <div class="rect_box">
                <div @click="go_to('https://leetcode.cn/problemset/')" class="rect_item fade_out rect_1 f a_c j_c_c r">
                  <svg t="1707152629827" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="5116" width="40" height="40">
                    <path
                    ...
                    <path
                      ...
                      fill="#000" p-id="5120"></path>
                  </svg>
                  <span>leetcode</span>
                </div>
                <div class="rect_item fade_out rect_2 f a_c j_c_c r" @click="go_to('https://codeforces.com/')">
                  <svg t="1708621098260" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="4204" width="40" height="40">
                    <path
                      ...
                      fill="#becbd3" p-id="4205"></path>
                  </svg>
                  <span>codeforces</span>
                </div>
                <div class="rect_item fade_out rect_3 f a_c j_c_c r" @click="
                  go_to('https://github.com/sparkle520?tab=repositories')
                  ">
                  <svg t="1711933909983" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="4210" width="52" height="52">
                    <path
                      ...
                      fill="#444444" p-id="4211"></path>
                  </svg>
                  <span>github</span>
                </div>
                <div class="rect_item fade_out rect_4 f a_c j_c_c r" @click="go_to('https://www.bilibili.com/')">
                  <svg t="1711934195026" class="icon" viewBox="0 0 1069 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="11197" width="42" height="42">
                    <path
                    ...
                    <path
                      ...
                      fill="#fb77b4" p-id="11199"></path>
                  </svg>
                  <span>bilibili</span>
                </div>
              </div>
            </div>
            <div class="page_2_nav_box f f_d_r a_c">
              <div class="page_2_nav_item fade_out f a_c j_c_c" @click="router.push('/article/list/all/1')">
                <svg t="1708542076555" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="12144" width="32" height="32">
                  <path d="M61.44 61.44h901.12v901.12H61.44V61.44z" fill="#202425" opacity=".01" p-id="12145"></path>
                  <path class="primary_mix_6_path"
                    ...
                    fill="#7dace4" p-id="12146"></path>
                  <path class="primary_path"
                    ...
                    fill="#8971d0" p-id="12147"></path>
                  <path class="fill_primary_path"
              ...
              <div class="page_2_nav_item fade_out f a_c j_c_c" @click="router.push('/note/1')">
                <svg t="1708542274864" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  ...
                  <path class="fill_primary_path"
                    ...
                    fill="#FFFFFF" p-id="21529"></path>
                  <path class="primary_path"
                    d="M848 745.344h33.28v99.968c0 36.864-29.824 66.688-66.688 66.688H681.216c0-92.032 74.624-166.656 166.784-166.656z"
                    fill="#8971d0" p-id="21530"></path>
                </svg>
                笔记
              </div>
              <div class="page_2_nav_item fade_out f a_c j_c_c" @click="router.push('/math/1')">
                <svg t="1708542488255" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="33539" width="32" height="32">
                  <path class="primary_path"
            ...
            <div class="new_topic_box f f_d_c">
              <ul class="f f_d_r new_item_box">
                <li v-for="(item, index) in new_topic_list" :key="item" @mouseenter="enter_new_topic(index)"
                  @mouseleave="leave_new_topic(index)" class="topic_item fade_item fade_out f f_d_c r">
                  <div class="img_box r">
                    <img @click="go_to_by_path(item.link)" v-if="item.img != ''" :src="item.img" class="img r" alt="" />
                    <img @click="go_to_by_path(item.link)" v-else
                      src="https://pic.imgdb.cn/item/65bb8e68871b83018ae48807.png" class="img r" alt="" />
                  </div>
            ...
            <div class="recommend_topic_box f f_d_c">
              ...
              <ul class="f f_d_r recommend_item_box">
                <li v-for="(item, index) in recommend_topic_list" :key="item"
                  class="recommend_item re_item fade_out f f_d_r">
                  <div class="img_box r">
                    <img @click="go_to_by_path(item.link)" v-if="item.img != ''" :src="item.img" alt="" />
                    <img @click="go_to_by_path(item.link)" v-else
                      src="https://pic.imgdb.cn/item/65bb8f6d871b83018ae8bcac.png" alt="" />
                  </div>
            ...
            <div class="re_note_box">
              ...
              <ul class="re_note_item_box f f_d_r">
                <li class="re_note_item fade_out r" v-for="item in re_note_list" :key="item">
                  <div class="re_note_img_box r">
                    <img @click="router.push(item.link)" v-if="item.img != ''" :src="item.img" alt="" />
                    <img v-else @click="router.push(item.link)"
                      src="https://pic.imgdb.cn/item/65cefd5f9f345e8d03620d1c.jpg" alt="" />
                  </div>
  ...
  <div class="home_foot r f f_d_r a_c j_c_c">
