  ...
  <div id="directory_list_main">
    <div class="catalog-card" v-show="layout">
      <div class="catalog-card-header f">
        <div class="f j_c_c">
          ...
          <div class="f f_d_r j_c_c a_c">
            ...
            <strong class="f f_d_r a_c"><svg t="1719710664540" class="catalog_icon" viewBox="0 0 1024 1024"
                version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1081" width="32" height="32">
                <path
                  d="M880.7936 323.1744h-224.5632c-28.2112 0-51.0464 22.4768-51.0464 50.2784v286.976c0 22.272 14.6944 41.1136 34.9696 47.7184 8.448 2.7648 17.664 1.536 25.1904-3.1744l87.1936-54.6304c4.1472-2.56 8.704-4.0448 13.3632-4.4544 6.4-0.5632 12.9024 0.9216 18.5856 4.4544l87.2448 54.6816c7.0144 4.4032 15.616 5.9392 23.552 3.6352 21.1456-6.144 36.5568-25.3952 36.5568-48.2304V373.4528c0-27.8016-22.8352-50.2784-51.0464-50.2784z"
                  fill="#EBAE44" opacity=".5" p-id="1082"></path>
                <path
                  d="M663.8592 151.6544H214.7328C158.3104 151.6544 112.64 196.6592 112.64 252.16v543.2832c0 44.4928 29.2864 82.176 69.9392 95.4368 16.8448 5.4784 35.328 3.072 50.3296-6.2976l174.4384-109.312a60.1088 60.1088 0 0 1 63.8464 0l174.5408 109.3632c14.0288 8.8064 31.1808 11.8272 47.104 7.2192 42.24-12.288 73.0624-50.7904 73.0624-96.4096V252.16c0-55.5008-45.6704-100.5056-102.0416-100.5056zM372.736 322.56h133.12c19.7632 0 35.84 16.0256 35.84 35.84 0 9.9328-3.9936 18.8416-10.496 25.344S515.7376 394.24 505.856 394.24h-133.12c-19.8144 0-35.84-16.0256-35.84-35.84s16.0256-35.84 35.84-35.84z m200.448 199.424A35.62496 35.62496 0 0 1 547.84 532.48H332.8c-19.8144 0-35.84-16.0256-35.84-35.84s16.0256-35.84 35.84-35.84h215.04c19.8144 0 35.84 16.0256 35.84 35.84 0 9.9328-3.9936 18.8416-10.496 25.344z"
                  fill="#EBAE44" p-id="1083"></path>
              </svg>版本索引</strong>
          </div>
        </div>
      </div>
      ...
      <div class="catalog-content">
        <div v-for="title in current_titles" :key="title.id" @click="scrollToView(title.scrollTop)" :class="[
          'catalog-item',
