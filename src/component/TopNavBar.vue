...
const nav_handle = () => {
  ...
  if (wScrY > last_position) {
    nav_main.style.transform = 'translateY(calc(-100% - 10px))';
...
#top_nav_main {
  ...
  box-shadow: #3031362d 2px 0px 10px;
  font-family: "orbitron-black";
  .content {
    width: 100%;
    height: 70px;
